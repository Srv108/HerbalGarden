    ...
    return(
        <> 
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <p className="flex justify-start mx-8">
                ...
                <p className="flex justify-start mx-8">We do not guarantee specific outcomes from the use of any medicinal plants or treatments described on this website. Results may differ widely between individuals. We advise users to exercise caution and to seek professional medical advice when considering the use of herbal remedies or Ayurvedic treatments.</p>
                ...
                <p className="flex justify-start mx-8">This website may contain links to third-party websites for your convenience and additional information. We do not endorse or accept responsibility for the content of these external sites. Any access to and use of such linked websites is at your own risk. </p>
                ...
                <p className="flex justify-start mx-8">We disclaim any liability for any loss, injury, or damage, whether direct, indirect, consequential, or incidental, arising out of or in connection with the use or reliance upon the information provided on this website or any third-party content linked from this site.</p>
